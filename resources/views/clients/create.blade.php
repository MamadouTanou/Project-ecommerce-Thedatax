               ...
               <div class="work-progres">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="panel panel-primary">	
                                    <div class="panel-heading" style="text-align: center;">Inscrire un client</div>
                                    <div class="panel-body"> 
                                        <div class="col-sm-12">
                                            {!! Form::open(['route' => 'client.store', 'class' => 'form-horizontal panel', 'enctype' => 'multipart/form-data']) !!}	
